"""
Django settings for yugiohstats project.
...
SECRET_KEY = 'django-insecure-&&t!)=kifkof=aj$u&i$k4++e3-s*$l3yx(m9_^_(yl(rxn$#m'
...
WSGI_APPLICATION = 'yugiohstats.wsgi.application'
